...
#define ALLOC_STR(PNTR, STRLEN, IERR)                   \
    ...
    {                                                   \
        PNTR = (char *) sicm_realloc ( PNTR, STRLEN );       \
        if (!PNTR )                                     \
        {                                               \
            perror("ALLOC_STR");                        \
            fprintf(stderr,                             \
...
#define REALLOC_2D(PNTR, NUMX, NUMY, TYPE, IERR)                        \
    PNTR = (TYPE *)sicm_realloc(PNTR, NUMX*NUMY*sizeof(TYPE));              \
    if (!PNTR)                                                          \
    {                                                                   \
     perror("REALLOC_2D");                                                \
     fprintf(stderr,                                                    \
...
#define ALLOC_1D(PNTR, NUM, TYPE, IERR)                                 \
                PNTR = (TYPE *)sicm_alloc(NUM * sizeof(TYPE));               \
                if (!PNTR)                                              \
                {                                                       \
                    perror("ALLOC_1D");                                 \
                    fprintf(stderr,                                     \
...
#define ALLOC_2D(PNTR, NUMX, NUMY, TYPE, IERR)                          \
    PNTR = (TYPE *)sicm_alloc((NUMX) * (NUMY) * sizeof(TYPE));               \
    if (!PNTR)                                                          \
    {                                                                   \
     perror("ALLOC_2D");                                                \
     fprintf(stderr,                                                    \
...
#define ALLOC_3D(PNTR, NUMX, NUMY, NUMZ, TYPE, IERR)                    \
    PNTR = (TYPE *)sicm_alloc((NUMX) * (NUMY) * (NUMZ) * sizeof(TYPE));      \
    if (!PNTR)                                                          \
    {                                                                   \
        perror("ALLOC_3D");                                             \
        fprintf(stderr,                                                 \
...
#define ALLOC_4D(PNTR, NUMW, NUMX, NUMY, NUMZ, TYPE, IERR)              \
    PNTR = (TYPE *)sicm_alloc((NUMW) * (NUMX) * (NUMY) * (NUMZ) *            \
                          sizeof(TYPE));                                \
    if (!PNTR)                                                          \
    {                                                                   \
        perror("ALLOC_4D");                                             \
...
#define ALLOC_5D(PNTR, NUMV, NUMW, NUMX, NUMY, NUMZ, TYPE, IERR)        \
    PNTR = (TYPE *)sicm_alloc((NUMV) * (NUMW) * (NUMX) * (NUMY) * (NUMZ) *   \
                              sizeof(TYPE));                            \
    if (!PNTR)                                                          \
    {                                                                   \
        perror("ALLOC_5D");                                             \
...
#define ALLOC_6D(PNTR, NUMU, NUMV, NUMW, NUMX, NUMY, NUMZ, TYPE, IERR)  \
    PNTR = (TYPE *)sicm_alloc((NUMU) * (NUMV) *(NUMW)                       \
                          * (NUMX) * (NUMY) * (NUMZ) *                   \
                              sizeof(TYPE));                            \
    if (!PNTR)                                                          \
    {                                                                   \
