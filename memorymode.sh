...
module load openmpi/3.1.3-gcc_7.2.1 likwid

export OMP_NUM_THREADS=1
RESULTS="${HOME}/memsys19-optane/results-memorymode"
# rm -rf ${RESULTS}
# mkdir -p ${RESULTS}
...
#     # mpirun -np $p likwid-perfctr -g L3CACHE  ./snap --fi ${p}_strong --fo ${RESULTS}/snap_strong_scaling.optane.$p.L3CACHE OPTANE &> ${RESULTS}/snap_strong_scaling.optane.$p.L3CACHE.likwi
